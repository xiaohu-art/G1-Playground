...
class MujocoViewer(Callbacks):
    ...
    def add_marker(self, **marker_params):
        marker_id = marker_params.pop("id", None)
        if marker_id is None:
            self._markers.append(marker_params)
        else:
            self._persistent_markers[marker_id] = marker_params
        ...
        def update():
            ...
            with self._gui_lock:
                ...
                mujoco.mjv_updateScene(
                    ...
                    self.scn)
                # marker items
                for marker in self._persistent_markers.values():
