    ...
    def test_configuration_data_lives_in_the_hydra_tree(self):
        ...
        self.assertEqual(
            yaml_files,
            {
                ...
                "motion/h20_clip_006_hold.yaml",
                "motion/h20_clip_007.yaml",
                "motion/h20_clip_007_hold.yaml",
                "motion/h20_clip_009.yaml",
                "motion/h20_clip_009_hold.yaml",
                "motion/h20_clip_014.yaml",
                "motion/h20_clip_014_hold.yaml",
                "motion/h20_clip_093.yaml",
                "motion/h20_clip_093_hold.yaml",
